...
export function Strategy() {
  ...
  return (
    <div className="fixed top-0 left-0 w-full bg-background backdrop-blur-sm z-10 p-4">
      <RadioGroup
        value={strategy}
        onValueChange={handleStrategyChange}
        className="flex flex-row w-fit mx-auto bg-primary/15 rounded-lg p-1 gap-1"
      >
